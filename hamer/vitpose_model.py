...
class ViTPoseModel(object):
    MODEL_DICT = {
        'ViTPose+-B (multi-task train, COCO)': {
            'config': f'{VIT_DIR}/configs/wholebody/2d_kpt_sview_rgb_img/topdown_heatmap/coco-wholebody/ViTPose_base_wholebody_256x192.py',
            'model': f'{ROOT_DIR}/_DATA/vitpose_ckpts/vitpose_base/wholebody.pth',
        },
    }
